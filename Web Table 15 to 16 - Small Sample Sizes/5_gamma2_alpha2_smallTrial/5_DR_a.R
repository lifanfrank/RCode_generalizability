...
for(i in 1:nsim){
  ...
  Zp<-cbind(1,both$Z1,both$Z2,both$Z3)
  Ze<-cbind(1,both$Z1,both$Z2)
  Zo<-cbind(1,both$Z1,both$Z2,both$Z3)
  
  res1<-DR1(Y,S,Zp,Ze,Zo,X,N)
  res2<-DR2(Y,S,Zp,Ze,Zo,X,N)
